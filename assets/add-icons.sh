cat > add-icons.sh <<'EOF'
#!/bin/bash
set -e

# pastikan ada folder icons
mkdir -p assets/icons

# bikin file linkedin.svg kalau belum ada
...
# sisipkan link linkedin ke index.html kalau belum ada
...
echo "✅ LinkedIn icon added to footer!"
EOF

chmod +x add-icons.sh
